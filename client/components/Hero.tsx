          ...
          <div className="space-y-8 animate-fadeInUp">
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                Tecnologia avançada que otimiza seu trabalho, aumenta a
                produtividade e gera resultados.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                className="border-2 border-corporate-blue-600 text-corporate-blue-600 hover:bg-corporate-blue-50 px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300 group"
              >

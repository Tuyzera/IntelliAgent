  ...
  const pillars = [
    {
      ...
      description: 'Atendimento especializado disponível a qualquer hora, adaptado às suas necessidades específicas.',
      icon: Clock,
    },
    {
      title: 'Automação de Vendas e Atendimento ao Cliente',
      description: 'Processos automatizados que aumentam conversões e melhoram a experiência do cliente.',
      icon: Target,
    },
    {
      title: 'Inteligência Artificial Adaptativa',
      description: 'IA que aprende continuamente com suas operações para otimizar resultados constantemente.',
      icon: Brain,
    },
    {
      title: 'Integração Simples com Ferramentas Existentes',
      description: 'Conecte facilmente com seus sistemas atuais sem interrup��ões nos processos.',
      icon: Puzzle,
    },
    {
      title: 'Resultados Comprovados e Garantidos',
      description: 'Histórico de sucesso com clientes e garantia de resultados mensuráveis.',
      icon: CheckCircle,
    },
    {
      title: 'Interface Intuitiva e Fácil de Usar',
      description: 'Design pensado para facilitar o uso, sem necessidade de treinamento complexo.',
      icon: Mouse,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Descubra os benefícios únicos que fazem nossa solução a escolha ideal para transformar seus resultados
          </p>
        </div>
